...
**1. Copy project**
```
Copy the school_library/ folder to:
C:\xampp\htdocs\school_library
```
...
- Click **New** → name it `school_library` → Create
- Click **Import** → select `database/school_library.sql` → Go
...
Make sure these exist inside the project:
```
uploads/books/
uploads/profiles/
```
